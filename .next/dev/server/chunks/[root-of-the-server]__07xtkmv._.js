...
"[project]/Documents/lumalabs-eng-take-home-e066572123aa9aa42123db943fd1456b5e05b85f/src/app/api/activities/[id]/intelligence/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function buildPhaseSummary(workoutType, phase) {
    return `This ${workoutLabel(workoutType)} fits your current ` + `${phase.phase.toLowerCase()} phase — ${phase.coachingImplication}`;
}
function buildLoadImpact(load, tl) {
...
async function GET(_request, { params }) {
    ...
    try {
        ...
        const [activity, ctx] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$lumalabs$2d$eng$2d$take$2d$home$2d$e066572123aa9aa42123db943fd1456b5e05b85f$2f$src$2f$lib$2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].activity.findUnique({
                where: {
                    id
                }
            }),
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$lumalabs$2d$eng$2d$take$2d$home$2d$e066572123aa9aa42123db943fd1456b5e05b85f$2f$src$2f$lib$2f$intelligence$2f$context$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["buildAthleteIntelligenceContext"])(athlete.id)
        ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__07xtkmv._.js.map