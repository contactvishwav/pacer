...
"[project]/Documents/lumalabs-eng-take-home-e066572123aa9aa42123db943fd1456b5e05b85f/src/lib/coach/system-prompt.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function buildSystemPrompt(ctx) {
    const lines = [];
    // ─── Persona
    lines.push(`You are Pacer, an AI running coach. You are coaching ${ctx.athlete.name}.`, '');
    // ─── HR zones
    lines.push('## Athlete HR Zones', `Easy ceiling: ${ctx.athlete.easyHRCeiling} bpm | Threshold: ${ctx.athlete.thresholdHR} bpm | Resting: ${ctx.athlete.restingHR} bpm`, '');
    // ─── Race goal
    if (ctx.goalRace) {
        const gr = ctx.goalRace;
        lines.push('## Race Goal', `${gr.name} — ${gr.raceDate} (${gr.daysUntilRace} days away)`, `Target: ${gr.goalTimeFormatted} | Distance: ${gr.distanceKm} km`);
        if (ctx.racePrediction) {
            const rp = ctx.racePrediction;
            lines.push(`Prediction: ${rp.predictedTimeFormatted} (${rp.gapToGoalFormatted} vs goal, confidence ${rp.confidenceScore}/10)`, `Path to goal: ${rp.whatNeedsToHappen}`);
        }
        lines.push('');
    }
    // ─── Current fitness
    const f = ctx.fitness;
    lines.push('## Current Fitness', `Phase: ${f.phase} (${f.phaseConfidence} confidence)`, `CTL ${f.ctl.toFixed(1)} | ATL ${f.atl.toFixed(1)} | TSB ${f.tsb.toFixed(1)} | ACWR ${f.acwr?.toFixed(2) ?? 'n/a'} (${f.acwrCategory})`, `Trend: ${f.trend}`, '');
    // ─── Injury risk
    const ir = ctx.injuryRisk;
    lines.push('## Injury Risk Signal', `${ir.category}: ${ir.explanation}`, `Recommended action: ${ir.recommendedAction}`);
    ...
    if (ctx.selectedActivity) {
        ...
        lines.push('## Activity Being Discussed', `${sa.date}: ${sa.workoutType} ${sa.distanceKm} km in ${sa.durationMinutes} min`);
        if (sa.avgHR) {
    ...
    lines.push('## Coaching Instructions', '- Be concise and direct. Target 150–250 words unless the question genuinely requires more.', '- Use specific numbers from the context when they support your point.', '- Use "risk signal", "training-load spike", "caution range" — never medical diagnoses.', '- Do not repeat information already visible on the athlete\'s dashboard.', '- End your response with exactly one suggested follow-up question on its own line, prefixed with "→ ".', '  Example: → How does my long run pace compare to race pace?');
    return lines.join('\n');
}
}),
"[project]/Documents/lumalabs-eng-take-home-e066572123aa9aa42123db943fd1456b5e05b85f/src/lib/coach/claude.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$lumalabs$2d$eng$2d$take$2d$home$2d$e066572123aa9aa42123db943fd1456b5e05b85f$2f$node_modules$2f40$anthropic$2d$ai$2f$sdk$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/Documents/lumalabs-eng-take-home-e066572123aa9aa42123db943fd1456b5e05b85f/node_modules/@anthropic-ai/sdk/index.mjs [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$lumalabs$2d$eng$2d$take$2d$home$2d$e066572123aa9aa42123db943fd1456b5e05b85f$2f$node_modules$2f40$anthropic$2d$ai$2f$sdk$2f$client$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__Anthropic__as__default$3e$__ = __turbopack_context__.i("[project]/Documents/lumalabs-eng-take-home-e066572123aa9aa42123db943fd1456b5e05b85f/node_modules/@anthropic-ai/sdk/client.mjs [app-route] (ecmascript) <export Anthropic as default>");
;
const g = globalThis;
const anthropic = g._anthropic ?? new __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$lumalabs$2d$eng$2d$take$2d$home$2d$e066572123aa9aa42123db943fd1456b5e05b85f$2f$node_modules$2f40$anthropic$2d$ai$2f$sdk$2f$client$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__Anthropic__as__default$3e$__["default"]();
if ("TURBOPACK compile-time truthy", 1) g._anthropic = anthropic;
const COACH_MODEL = process.env.ANTHROPIC_MODEL ?? 'claude-sonnet-4-6';
}),
"[project]/Documents/lumalabs-eng-take-home-e066572123aa9aa42123db943fd1456b5e05b85f/src/lib/coach/deterministic.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s([
    "buildDeterministicCoachingResponse",
    ()=>buildDeterministicCoachingResponse
]);
function buildDeterministicCoachingResponse(context) {
    const parts = [];
    // 1. Phase + days until race
    const phase = context.fitness.phase.replace(/_/g, ' ').toLowerCase();
    const daysNote = context.fitness.daysUntilRace > 0 ? ` with ${context.fitness.daysUntilRace} days until your race` : '';
    ...
    if (injuryRisk.category === 'caution' || injuryRisk.category === 'high-risk') {
        parts.push(`Injury risk signal: ${injuryRisk.explanation}\n${injuryRisk.recommendedAction}`);
    }
...
"[project]/Documents/lumalabs-eng-take-home-e066572123aa9aa42123db943fd1456b5e05b85f/src/app/api/coach/conversations/[id]/messages/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$lumalabs$2d$eng$2d$take$2d$home$2d$e066572123aa9aa42123db943fd1456b5e05b85f$2f$src$2f$lib$2f$coach$2f$system$2d$prompt$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Documents/lumalabs-eng-take-home-e066572123aa9aa42123db943fd1456b5e05b85f/src/lib/coach/system-prompt.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$lumalabs$2d$eng$2d$take$2d$home$2d$e066572123aa9aa42123db943fd1456b5e05b85f$2f$src$2f$lib$2f$coach$2f$claude$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Documents/lumalabs-eng-take-home-e066572123aa9aa42123db943fd1456b5e05b85f/src/lib/coach/claude.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$lumalabs$2d$eng$2d$take$2d$home$2d$e066572123aa9aa42123db943fd1456b5e05b85f$2f$src$2f$lib$2f$coach$2f$deterministic$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Documents/lumalabs-eng-take-home-e066572123aa9aa42123db943fd1456b5e05b85f/src/lib/coach/deterministic.ts [app-route] (ecmascript)");
...
async function GET(_request, { params }) {
    ...
    const conversation = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$lumalabs$2d$eng$2d$take$2d$home$2d$e066572123aa9aa42123db943fd1456b5e05b85f$2f$src$2f$lib$2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].coachConversation.findUnique({
        where: {
            id: conversationId
        }
    });
    if (!conversation || conversation.athleteId !== athlete.id) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$lumalabs$2d$eng$2d$take$2d$home$2d$e066572123aa9aa42123db943fd1456b5e05b85f$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json((0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$lumalabs$2d$eng$2d$take$2d$home$2d$e066572123aa9aa42123db943fd1456b5e05b85f$2f$src$2f$lib$2f$schemas$2f$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiError"])('Conversation not found.'), {
            status: 404
        });
    }
    const messages = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$lumalabs$2d$eng$2d$take$2d$home$2d$e066572123aa9aa42123db943fd1456b5e05b85f$2f$src$2f$lib$2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].coachMessage.findMany({
        where: {
            conversationId
        },
        orderBy: {
...
async function POST(request, { params }) {
    ...
    if (!userMessage) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$lumalabs$2d$eng$2d$take$2d$home$2d$e066572123aa9aa42123db943fd1456b5e05b85f$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json((0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$lumalabs$2d$eng$2d$take$2d$home$2d$e066572123aa9aa42123db943fd1456b5e05b85f$2f$src$2f$lib$2f$schemas$2f$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiError"])('Request body must include a non-empty "message" field.'), {
            status: 400
        });
    }
    // Build context (loads last 8 messages + memories from DB)
    const coachCtx = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$lumalabs$2d$eng$2d$take$2d$home$2d$e066572123aa9aa42123db943fd1456b5e05b85f$2f$src$2f$lib$2f$intelligence$2f$context$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["buildCoachContext"])(athlete.id, conversation.activityId ?? undefined);
    const systemPrompt = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$lumalabs$2d$eng$2d$take$2d$home$2d$e066572123aa9aa42123db943fd1456b5e05b85f$2f$src$2f$lib$2f$coach$2f$system$2d$prompt$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["buildSystemPrompt"])(coachCtx);
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$lumalabs$2d$eng$2d$take$2d$home$2d$e066572123aa9aa42123db943fd1456b5e05b85f$2f$src$2f$lib$2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].coachMessage.create({
        data: {
            conversationId,
            role: 'USER',
            content: userMessage
    ...
    if (!process.env.ANTHROPIC_API_KEY) {
        ...
        const fallbackText = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$lumalabs$2d$eng$2d$take$2d$home$2d$e066572123aa9aa42123db943fd1456b5e05b85f$2f$src$2f$lib$2f$coach$2f$deterministic$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["buildDeterministicCoachingResponse"])(coachCtx);
    ...
    const stream = new ReadableStream({
        async start (controller) {
            try {
                const anthropicStream = __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$lumalabs$2d$eng$2d$take$2d$home$2d$e066572123aa9aa42123db943fd1456b5e05b85f$2f$src$2f$lib$2f$coach$2f$claude$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["anthropic"].messages.stream({
                    model: __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$lumalabs$2d$eng$2d$take$2d$home$2d$e066572123aa9aa42123db943fd1456b5e05b85f$2f$src$2f$lib$2f$coach$2f$claude$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["COACH_MODEL"],
                    max_tokens: 1024,
                    system: systemPrompt,
                    messages
                });
                ...
                const fallbackText = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$lumalabs$2d$eng$2d$take$2d$home$2d$e066572123aa9aa42123db943fd1456b5e05b85f$2f$src$2f$lib$2f$coach$2f$deterministic$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["buildDeterministicCoachingResponse"])(coachCtx);
                const combinedContent = fullText ? fullText + '\n\n' + fallbackText : fallbackText;
                const tokens = fallbackText.split(' ');
                for (const token of tokens){
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0l.7.s7._.js.map